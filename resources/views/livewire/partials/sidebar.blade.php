<aside
    id="mobile-sidebar"
    class="sidebar absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static {{ $sidebarToggle ? 'sidebar-open' : '' }}"
>
    <!-- SIDEBAR HEADER -->
